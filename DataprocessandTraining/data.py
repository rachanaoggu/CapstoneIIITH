...
def train_model():
    ...
    spark=SparkSession \
        ...
        .config("spark.mongodb.input.uri", "mongodb://localhost:27017/news_database.new_data") \
        .config("spark.mongodb.output.uri", "mongodb://localhost:27017/news_database.new_data") \
